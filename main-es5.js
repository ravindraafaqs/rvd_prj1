  ...
  function srcAppBottomBottomComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function BottomComponent(singh) {
        ...
        this.singh = singh; //hero-image-s3-key = 'myImages';
    ...
    function () {
      ...
      _createClass(MyservService, [{
        ...
        value: function fetchLatestNews() {
          var url = 'https://www.afaqs.com/api/v1/collections/top-story'; // const url='https://www.afaqs.com/api/v1/collections/latest-stories'
